...
MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "knn.pkl")
METRICS_SAVE_PATH = os.path.join(METRICS_DIR, "knn.json")
...
def main():
    print("=" * 60)
    print("  K-Nearest Neighbor (KNN) Training")
    print("=" * 60)
    ...
    print("[train] Training KNN Classifier (k=5)...")
