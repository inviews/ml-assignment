...
MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "decision_tree.pkl")
METRICS_SAVE_PATH = os.path.join(METRICS_DIR, "decision_tree.json")
...
def main():
    ...
    print("[train] Training Decision Tree Classifier...")
